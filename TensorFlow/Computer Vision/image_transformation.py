...
# Display image.
PIL.Image.fromarray(img_array).show()
...
PIL.Image.fromarray(random_contrast(img_array).numpy()).show()
...
PIL.Image.fromarray(random_saturation(img_array).numpy()).show()
...
PIL.Image.fromarray(random_hue(img_array).numpy()).show()
...
PIL.Image.fromarray(distorted_random_crop(img_array).numpy()).show()
...
PIL.Image.fromarray(transformed_img).show()
...
PIL.Image.fromarray(resize_image(transformed_img).numpy()).show()
